...
use DB;
use App;
use ArtisanAli\Messenger\Exceptions\MessengerException;
...
class Messenger
{
     ...
     * Send message.
     *
     * @return \ArtisanAli\Messenger\Contracts\MessageInterface
     */
     ...
     * found, create one.
     *
     * @return \ArtisanAli\Messenger\Models\MessageThread
     */
